    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-t from-lime-50 via-transparent to-transparent pointer-events-none z-10" />
          <div className="bg-white rounded-2xl  p-4 max-full mx-auto">
            <div className="border-b border-lime-100 pb-4 mb-4 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <div className="h-3 w-3 rounded-full bg-lime-200" />
            ...
            <div className="space-y-4 p-4">
              ...
              <Skeleton className="h-4 bg-lime-100 rounded w-3/4" />
              <Skeleton className="h-4 bg-lime-100 rounded w-full" />
              <Skeleton className="h-4 bg-lime-100 rounded w-2/3" />
            </div>
          </div>
        </div>
        <div className="flex justify-center gap-4">
          ...
          <Link href="#features">
            <Button
              variant="outline"
              className="px-8 py-6 rounded-full border-lime-600 text-lime-600 hover:bg-lime-100"
            >
              Learn More
            </Button>
          </Link>
        ...
        {features.map((feature, index) => (
          <Card key={index} className="shadow-lg">
            <CardContent className="p-6">
              <div className="h-12 w-12 bg-lime-100 rounded-full flex items-center justify-center mb-4">
                <feature.icon className="h-6 w-6 text-lime-600" />
              </div>
              <h3 className="font-semibold text-xl text-lime-900 mb-2">
                {feature.title}
              </h3>
      ...
      <div className="space-y-24 mt-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 ">
          ...
          <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-lime-100">
            {/* Editor Preview */}
            <div className="flex gap-2 mb-6">
              <div className="h-8 w-8 rounded bg-lime-100"></div>
              <div className="h-8 w-8 rounded bg-lime-100"></div>
              <div className="h-8 w-8 rounded bg-lime-100"></div>
            </div>
            <div className="h-4 bg-lime-50 rounded w-3/4"></div>
            <div className="h-4 bg-lime-50 rounded w-full"></div>
            <div className="h-4 bg-lime-50 rounded w-2/3"></div>
            <div className="h-4 bg-lime-50 rounded w-1/3"></div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:flex-row-reverse">
          <div className="space-y-6 md:order-2">
            <div className="h-12 w-12 bg-lime-100 rounded-full flex items-center justify-center">
              <BarChart2 className="h-6 w-6 text-lime-600" />
            </div>
            <h3 className="text-2xl font-bold text-lime-900">Mood Analytics</h3>
            <p className="text-lg text-lime-700">
          ...
          <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-lime-100 md:order-1">
            {/* Analytics Preview */}
            <div className="h-40 bg-gradient-to-t from-lime-100 to-orange-50 rounded-lg"></div>
            <div className="flex justify-between">
              <div className="h-4 w-16 bg-lime-100 rounded"></div>
              <div className="h-4 w-16 bg-lime-100 rounded"></div>
              <div className="h-4 w-16 bg-lime-100 rounded"></div>
            </div>
          </div>
      ...
      {/* FAQ Section */}
      <div className="mt-24">
        <h2 className="text-3xl font-bold text-center text-lime-900 mb-12">
          Frequently Asked Questions
        </h2>
        <Accordion type="single" collapsible className="w-full mx-auto">
          {faqs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`}>
              <AccordionTrigger className="text-lime-900 text-lg">
                {faq.q}
              </AccordionTrigger>
              <AccordionContent className="text-lime-700">
                {faq.a}
              </AccordionContent>
            </AccordionItem>
          ))}
      ...
      {/* CTA Section */}
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-lime-100 to-amber-100">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold text-lime-900 mb-6">
              Start Reflct-ing on Your Journey Today
            </h2>
            <p className="text-lg text-lime-700 mb-8 max-w-2xl mx-auto">
