...
export default function JournalEntryPage() {
  ...
  }, [editId, fetchCollections, fetchEntry, fetchDraft]);
  ...
  useEffect(() => {
    ...
    } else if (!isEditMode && draftData?.success) {
      reset({
  ...
  const handleSaveDraft = async () => {
    ...
    const result = await saveDraftFn(watch());
    if (result?.success) {
      ...
      <form onSubmit={onSubmit} className="space-y-4 mx-auto">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={errors.title ? "border-green-700" : ""}
          />
          {errors.title && (
            <p className="text-green-700 text-sm">{errors.title.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select onValueChange={field.onChange} value={field.value}>
                <SelectTrigger
                  className={errors.mood ? "border-green-500" : ""}
                >
          ...
          />
          {errors.mood && (
            <p className="text-green-500 text-sm">{errors.mood.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.content && (
            <p className="text-green-500 text-sm">{errors.content.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            render={({ field }) => (
              ...
              >
                <SelectTrigger>
                  <SelectValue placeholder="Pick a collection (optional)" />
                </SelectTrigger>
                <SelectContent>
